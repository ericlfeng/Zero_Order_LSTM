...
# Base shared flags
BASE_PARAMS="--task penn_tree_bank --model_type LSTM --n_layers 3 --micro_batch_size 512 --macro_batch_size 1 --seq_length 10 --max_iterations 500000 --distribution rad --tokenizer char_level --warmup_iters 1 --seed 42 --beta1 0. --beta2 0."
